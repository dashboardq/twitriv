        <div class="view"><?php echo nl2br(_esc($note)); ?><button class="_close" aria-label="Close">&times;</button></div>
        <form action="/ajax/todo/add" class="edit" method="POST">
            <fieldset>
                ...
                <textarea name="note" placeholder="Enter your todo notes..."><?php esc($note); ?></textarea>
